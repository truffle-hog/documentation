...
FA470: & \textit{IO\_Supervisor festlegen: }Der Benutzer kann Geräte eindeutlig spezifizieren, die das Programm als IO Supervisor markiert \\ % TODO (wie) wollen wir das im graphen repräsentieren?
