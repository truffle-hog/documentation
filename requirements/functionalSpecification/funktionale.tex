...
FA130: & \textit{Erkennen neuer Netzwerkteilnehmer: }Das Programm erkennt neue Netzwerkteilnehmer und, falls wie in FA 420/425 beschrieben und aktiviert, vergleicht den Netzwerkteilnehmer mit der \gls{whitelist} und \gls{blacklist}. Sollte ein \gls{blacklist}-Treffer vorliegen, wird Kante und Knoten als illegal markiert. \\
