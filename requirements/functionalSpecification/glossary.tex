...
\newglossaryentry{identifyrequest}{
    ...
    description={Eine Anfrage eines Netzwerkteilnehmers (typischerweise eines \gls{io-supervisor}s oder \gls{iocontroller}s) im \gls{profinet} System der die Identität eines anderen einfordert}
}
