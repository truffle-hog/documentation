...
{mac}{MAC}{Media Access Control}
  ...
  name=Whitelist,
  description={Eine Liste auf der sich vertrauenswürdig Geräte (Knoten) befinden. Alle Geräte die sich nicht auf dieser Liste befinden werden als potenziell gefährlich gewertet und blockiert.}
}
