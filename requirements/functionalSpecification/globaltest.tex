...
\begin{description}[style=multiline, leftmargin=4cm, labelwidth=4cm]
  ...
  \testcase{errpak}{Fehlerhaftes Paket} Ein fehlerhaftes \gls{paket} wird von einem Paketsender gesendet, erkannt (\ref{fa10}) und der Nutzer lässt sich die \gls{log}-Dateien anzeigen und sieht das als fehlerhaft markierte \gls{paket}(\ref{fa280}) .
