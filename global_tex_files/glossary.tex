...
\newglossaryentry{fxml-datei} {
  name=FXML Datei,
  plural=FXML Dateien,
  description={Eine FXML-Datei beschreibt das komplette Layout einer GUI.}
}
...
\newglossaryentry{truffle}{
		name=Truffle,
		plural=Truffles,
    description={Die Datenstruktur in der Netzwerkpakete gekapselt werden in \gls{programname}. Hier befinden sich alle Informationen über das Netzwerkpaket, bis auf die Daten des Paketes selber, die aus Platzgründen weggeworfen werden.}
}
...
\newglossaryentry{proxypattern}{
    name=Proxy-Pattern,
    description={Ein Entwurfsmuster zur sicheren und entkoppelten Verwendung entfernter Objekte}
}
