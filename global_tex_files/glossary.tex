...
\newglossaryentry{command}{
    name=Command,
		plural=Commands,
    description={Ein Befehl der auf dem Model ausgeführt wird. Mehr im \hyperref[subsec:command]{command-Package}-Package}.
}

\newglossaryentry{executor}{
    name=Executor,
		plural=Executors,
    description={Ein Befehl der auf dem Model ausgeführt wird. Mehr im \hyperref[subsec:command]{executor-Package}-Package}.
}

\newglossaryentry{replaylog}{
    name=ReplayLog,
		plural=Executors,
    description={Ein Befehl der auf dem Model ausgeführt wird. Mehr im \hyperref[subsec:replaylogging]{replaylogging}-Package}.
}
