...
Insekura & Die Firma deren Geräte \gls{profinet} zur internen Kommunikation verwenden. \\
...
In der Hoffnung Unfälle und Attacken solcher Art in Zukunft vermeiden zu können, installiert sie die freie Software \gls{programname} und lässt sie auf einem gut sichtbaren Bildschirm in ihrem Büro dauerhaft in Betrieb. Auf dem Display sieht sie sämtliche \textit{Geräte als Knoten} eines Graphen und kann die \textit{Kommunikationswege zwischen Geräten und Controllern durch gerichtete Kanten} gut verfolgen. In den Einstellungen von \gls{programname} \textit{fügt sie den Adressraum des Firmennetzes zu den erlaubten Kommunikationsadressen hinzu}.
...
Während sich Bob den Zugang auf das System verschafft, sitzt Alice in ihrem Büro und hat ihren Blick gerade auf den Bildschirm mit dem laufenden \gls{programname} gerichtet. Sie sieht wie ein \textit{roter Knoten auf dem Bildschirm erscheint} und mit einer der Drehmaschinen zu kommunizieren beginnt. \textit{Die Kommunikationskante ist auch rot gekennzeichnet}. Sofort eilt Alice zur Tür und drückt auf den Notfall Ausschalter des Systems. Schlimmeres konnte verhindert werden.

\subsection{Szenario 3: Auslesen von Logdateien}

Alice \textit{öffnet die Logdatei des roten Knotens}, der den Angriff gestartet hat, und kann dadurch zurückverfolgen, wer sich unerlaubten Zugriff auf das Firmennetzwerk verschafft hat. Bob steht eine große Schadensersatzklage bevor.
...
\begin{figure}[h!]
    ...
    \caption[Anwendungsfalldiagramm Benutzerinteraktion]{Anwendungsfalldiagramm Benutzerinteraktion}
\end{figure}
